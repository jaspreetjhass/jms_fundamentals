...
public class ObjectMessageProducer {
	...
	public static void main(String[] args) throws JMSException {
		ClassPathXmlApplicationContext context = new ClassPathXmlApplicationContext("application-context-jndi.xml");
		...
		//case - 5 object without serialization, in this case message converter is required 
		Patient patient = Patient.builder().id(122).name("jaspreet").insuranceProvider("healthnet").copay(89.0).amountPayable(78.90).build();
